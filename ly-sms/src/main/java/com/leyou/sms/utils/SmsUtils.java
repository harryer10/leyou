...
public class SmsUtils {
    ...
    private static final long SMS_MIN_INTERVAL_IN_MILLS = 60000;
    ...
    public SendSmsResponse sendSms(String phoneNumber, String signName,
        ...
        try {
            ...
            if (!"OK".equals(resp.getCode())) {
                log.info("[短信服务] 发送短信失败，phone number:{}, 原因：{}", phoneNumber, resp.getMessage());
            }
            ...
            log.error("短信服务] 发送短信异常，phone number:{}", phoneNumber, e);
            return null;
        }
    }
}
